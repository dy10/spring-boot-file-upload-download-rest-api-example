...
```bash
git clone https://github.com/dy10/spring-boot-file-upload-download-rest-api-example.git
```
...
Upload a file
```bash
curl -v -F path=test/hello -F file=@a.txt http://localhost:9090/uploadFile
```